  ...
  return knex("comments")
    ...
    .then(function() {
      return knex("comments").insert([
        ...
        {
          text:
            "A good travel has no fixed plans and is not intent upon arriving. A good artist lets his intuition lead him where ever it wants.",
          post_id: 5
        },
        {
          text:
        ...
        {
          text:
            "She acts without expectation, succeeds without taking credit and doesn't think she is better than anyone else.",
          post_id: 7
        },
        ...
        {
          text:
            "He who tries to shine dims his own light. He who defines himself can't know who he really is. He who clings to his work will do nothing that endures. Just do your job, then let go.",
          post_id: 8
        }
      ]);
    });
